...
import { Eye, EyeOff, Lock, LucideOctagonMinus, Mail, User } from 'lucide-react'
...
const Login = ({onLogin, API_URL = "http://localhost:4000"}) => {
    ...
    try {
      ...
      if(typeof onLogin === "function"){
        try {
          ...
          console.warn("onLogin Trow:", callErr);
          navigate("/");
        ...
        <div className='mb-6'>
            ...
            <div className={loginStyles.checkboxContainer}>
              <input type="checkbox"
                ...
                required
                />
                <label htmlFor='remeber' className={loginStyles.checkboxLabel}>
                  Remember Me
  ...
  fill="currentColor"
  d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3 2.353V17.291z"
/>
                  </svg>
                  Signing in...
                </>
